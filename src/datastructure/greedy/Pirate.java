package datastructure.greedy;//package com.xiaolong.greedy;
//
...
//        //int weight = 0;
//        //int count = 0;
//        //for (int i = 0; i < weights.length && weight <= capatity; i++){
...
//        int nowMoney = 0;
//
//        for (int i = face.length - 1; i >= 0 && money > 0; i--) {
//            System.out.println(i);
//            if (money < face[i]) continue;
